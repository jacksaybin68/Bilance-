...
async function bootstrap() {
  ...
  app.useGlobalInterceptors(
    // Enforces @Exclude() on serialized entities — without this interceptor,
    // entities carrying UserEntity relations (e.g. chat conversations, orders)
    // would emit passwordHash to the client.
