...
const STORAGE_KEY = 'okbong.locale';
...
export function I18nProvider({ children }: { children: React.ReactNode }) {
  // Always boot with the default locale so server and first client render match,
  // then hydrate from localStorage to avoid a mismatch warning.
...
export { LOCALES, LOCALE_LABELS, DEFAULT_LOCALE } from './messages';
