...
const vi = {
  ...
  'chat.subtitle': 'Trao đổi trực tiếp với bộ phận hỗ trợ của chúng tôi.',
  'chat.balanceLabel': 'Số dư ví',
  'chat.empty': 'Chưa có tin nhắn. Hãy gửi cho chúng tôi một câu hỏi!',
  'chat.placeholder': 'Nhập tin nhắn của bạn…',
  'chat.send': 'Gửi',
  'chat.sendError': 'Không gửi được tin nhắn, vui lòng thử lại.',
  'chat.error': 'Không tải được lịch sử chat, vui lòng thử lại.',
  'chat.hint': 'Nhấn Enter để gửi, Shift + Enter để xuống dòng.',
  'orders.title': 'Đặt lệnh',
  'orders.subtitle': 'Đặt lệnh và theo dõi kết quả (thắng/thua).',
  'orders.place': 'Tạo lệnh mới',
  'orders.pair': 'Cặp tiền',
  'orders.side': 'Hướng',
  'orders.amount': 'Tiền cược',
  'orders.price': 'Tỷ giá',
  'orders.submit': 'Đặt lệnh',
  'orders.held': 'Đã trừ điểm cho lệnh:',
  'orders.heldHint': 'Số tiền cược được trừ ngay khỏi ví khi đặt lệnh. Kết quả sẽ được xác nhận bởi quản trị viên.',
  'orders.invalidAmount': 'Vui lòng nhập số tiền cược hợp lệ.',
  'orders.placeError': 'Không đặt lệnh được, vui lòng thử lại.',
  'orders.history': 'Lịch sử lệnh',
  'orders.empty': 'Bạn chưa có lệnh nào.',
  'orders.createdAt': 'Thời gian',
  'orders.error': 'Không tải được danh sách lệnh, vui lòng thử lại.',
...
const en: Record<string, string> = {
  ...
  'chat.subtitle': 'Chat directly with our support team.',
  'chat.balanceLabel': 'Wallet balance',
  'chat.empty': 'No messages yet. Send us a question!',
  'chat.placeholder': 'Type your message…',
  'chat.send': 'Send',
  'chat.sendError': 'Failed to send message, please try again.',
  'chat.error': 'Failed to load chat history, please try again.',
  'chat.hint': 'Press Enter to send, Shift + Enter for a new line.',
  'orders.title': 'Place Order',
  'orders.subtitle': 'Place orders and track win/lose results.',
  ...
  'orders.held': 'Points held for order:',
  'orders.heldHint': 'The stake is deducted from your wallet when you place an order. The result is confirmed by an administrator.',
  'orders.invalidAmount': 'Please enter a valid stake amount.',
  'orders.placeError': 'Failed to place order, please try again.',
  'orders.history': 'Order history',
  'orders.empty': 'You have no orders yet.',
  'orders.createdAt': 'Time',
  'orders.error': 'Failed to load orders, please try again.',
